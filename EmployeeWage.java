...
interface EmployeeWageCalculatorInterface {
    void addCompanies(CompanyDetails companyDetails, int index);
    void calculateTotalWage();
    
}
class EmployeeWageCalculator implements EmployeeWageCalculatorInterface{
    ...
    public void calculateTotalWage() {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'calculateTotalWage'");
    }
}
